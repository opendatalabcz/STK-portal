...
export default function AverageInspectionCountBySeverityBrowser() {
  ...
  if (rawData == undefined) {
    return (
      <Card title="Průměrný počet lehkých a vážných závad">
  ...
  return (
    <Card
      title="Průměrný počet lehkých a vážných závad"
      extra={
