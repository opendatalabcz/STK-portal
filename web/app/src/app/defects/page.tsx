...
export default async function StationsPage() {
  let data: Defect[] = await (await fetch(`${process.env.api}/defects`)).json();
    ...
    <>
      ...
      <Container>
        ...
        <p>
          ...
          číselník mírně upravují, ale pro účely analýzy dat dostupných na tomto
          webu mezi nimi není rozdíl. Může se pouze stát, že některá z novějších
          prohlídek dostupná v detailu vozidla obsahuje závadu, která v tomto
          číselníku není.
        </p>
