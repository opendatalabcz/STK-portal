...
export default function DefectsBySeverityAgeDriveTypeMediumChart({
  firstMake,
  firstModel,
  secondMake,
  secondModel,
  ...
  return (
    <Card size="small" title="Vážné závady">
  ...
  function _buildChart() {
    ...
    const data = {
      ...
      datasets: [
        {
          label: `${firstMake} ${firstModel}: vážné`,
          data: firstDefectsB,
          borderColor: red[4],
          backgroundColor: red[4],
        },
        {
          label: `${secondMake} ${secondModel}: vážné`,
          data: secondDefectsB,
          borderColor: cyan[5],
